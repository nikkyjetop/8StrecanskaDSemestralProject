...
/**
 * Uloha cislo 8. Program, ktorý bude zadanú sadu bodov v 3D triediť podľa 
 * vzrastajúcej vzdialenosti jednotlivých bodov od počiatku 
...
public class Semestralnapraca {
    ...
    //semestralna praca - triedenie bodov v 3D
        ...
        while (true) {
            ...
            if (odpoved.equals("a")) {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    pole[i] = b;
                    //System.out.println(b.vzdialenost);
                }
                Bod swap;
    ...
    //vianocna uloha - uzivatel si vyberie aky velky vianocny darcek chce dostat
